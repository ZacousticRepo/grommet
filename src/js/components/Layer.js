...
class LayerContents extends Component {
  ...
  render () {
    ...
    return (
      <div ref={ref => this.containerRef = ref} className={`${CLASS_ROOT}__container`}>
...
export default class Layer extends Component {
  ...
  _classesFromProps () {
    const {
      align, className, closer, flush, hidden, peek, clickThrough
    } = this.props;
    ...
    return classnames(
      ...
      CLASS_ROOT,
      {
        ...
        [`${CLASS_ROOT}--clickthrough`]: clickThrough,
      },
      className
    );
  }
