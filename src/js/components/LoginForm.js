...
export default class LoginForm extends Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      username: props.username || props.defaultValues.username || '',
    };
  }
      ...
      <Form className={classes} pad="medium" onSubmit={this._onSubmit}>
        ...
        <fieldset>
          <FormField htmlFor="username" label={username}>
            <input id='grommetUserNameInput' autoFocus type={usernameType} ref={ref => this.usernameRef = ref}
              value={this.state.username}
              onChange={this._onUsernameChange} />
          </FormField>
          <FormField htmlFor="password" label={password}>
            <input id='grommetPasswordInput' type="password" value={this.state.password}
