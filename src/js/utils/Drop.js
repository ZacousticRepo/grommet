...
export default class Drop {
  ...
  place () {
    const {
      control, container, initialFocusNeeded, options: { align, responsive, overrideDropResizing }
    } = this.state;
    ...
    if (overrideDropResizing && controlRect.width < width) {
      width = controlRect.width;   
      left = (containerRect.width - controlRect.width) / 2;         
    }
